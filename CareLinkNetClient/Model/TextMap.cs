...
public class TextMap {
    ...
    public static string ERROR_TEXT_PREFIX_GUARDIAN = "GM_";
    public static string ERROR_TEXT_PREFIX_NGP = "N";

    private static Hashtable ErrorTextMap = new()
    {
        { "", "" },
        { "3", "Battery out limit" },
    ...
    private static Hashtable ErrorCodeMap = new Hashtable()
    {
        { "002", "002" },
        { "003", "002" },
        { "004", "002" },
    ...
    protected static string GetErrorMessage(string deviceFamily, string guardianErrorCode, int ngpErrorCode)
    {
        string errorTextId;
        string internalEC;
        ...
        {
            string formattedEC = $"{ngpErrorCode:D3}";
            if(ErrorCodeMap.ContainsKey(formattedEC))
                internalEC = (string)ErrorCodeMap[formattedEC];
            else
        ...
        if(errorTextId != null && ErrorTextMap.ContainsKey(errorTextId))
            return (string)ErrorTextMap[errorTextId];
        else
            return "";
    }
